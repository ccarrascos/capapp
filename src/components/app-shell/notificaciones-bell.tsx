        ...
        <div className="max-h-96 overflow-y-auto">
          ...
          {notificaciones.map((n) => (
            ...
            >
              ...
              ) : n.tipo === "curso_finalizado" ? (
                <CircleCheck className="size-4 text-clear mt-0.5 shrink-0" />
              ) : n.tipo === "certificado_emitido" ? (
                <FileCheck2 className="size-4 text-clear mt-0.5 shrink-0" />
              ) : (
